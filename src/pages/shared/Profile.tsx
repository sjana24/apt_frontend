...
import { User, Mail, Shield, Key, Eye, EyeOff, Loader2, CheckCircle2 } from "lucide-react";
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground text-lg">Manage your profile information and security.</p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-12">
                    ...
                    <CardContent className="space-y-6 pt-6 border-t border-border/50">
                        <div className="flex items-start gap-4 p-4 rounded-xl bg-muted/30">
                            ...
                            <div className="space-y-0.5">
                                <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground/60">Email Address</p>
                                <p className="text-sm font-semibold">{profile?.email}</p>
                                <p className="text-[10px] text-muted-foreground">Primary contact email (Read only)</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-xl bg-muted/30">
                            ...
                            <div className="space-y-0.5">
                                <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground/60">Account Security</p>
                                <p className="text-sm font-semibold">Two-Factor Enabled</p>
                                <p className="text-[10px] text-muted-foreground">Managed by system administrator</p>
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card className="md:col-span-7 border-border/50 shadow-xl shadow-black/5 overflow-hidden">
                    ...
                    <CardContent className="pt-8 px-8">
                        <form id="password-form" onSubmit={handlePasswordChange} className="space-y-6 text-left">
                            ...
                            <div className="p-4 rounded-lg bg-orange-50 border border-orange-100 flex gap-3 items-start">
                                ...
                                <div className="space-y-1">
                                    <p className="text-sm font-bold text-orange-900 leading-none">Security Tip</p>
